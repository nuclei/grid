...
::slotted([column~="1"]){ grid-column-end: span 1; }
::slotted([column~="2"]){ grid-column-end: span 2; }
::slotted([column~="3"]){ grid-column-end: span 3; }
::slotted([column~="4"]){ grid-column-end: span 4; }
::slotted([column~="5"]){ grid-column-end: span 5; }
::slotted([column~="6"]){ grid-column-end: span 6; }
::slotted([column~="7"]){ grid-column-end: span 7; }
::slotted([column~="8"]){ grid-column-end: span 8; }
::slotted([column~="9"]){ grid-column-end: span 9; }
::slotted([column~="10"]){ grid-column-end: span 10; }
::slotted([column~="11"]){ grid-column-end: span 11; }
::slotted([column~="12"]){ grid-column-end: span 12; }
::slotted([column~="13"]){ grid-column-end: span 13; }
::slotted([column~="14"]){ grid-column-end: span 14; }
::slotted([column~="15"]){ grid-column-end: span 15; }
::slotted([column~="16"]){ grid-column-end: span 16; }
::slotted([column~="17"]){ grid-column-end: span 17; }
::slotted([column~="18"]){ grid-column-end: span 18; }
::slotted([column~="19"]){ grid-column-end: span 19; }
::slotted([column~="20"]){ grid-column-end: span 20; }
::slotted([column~="21"]){ grid-column-end: span 21; }
::slotted([column~="22"]){ grid-column-end: span 22; }
::slotted([column~="23"]){ grid-column-end: span 23; }
::slotted([column~="24"]){ grid-column-end: span 24; }
